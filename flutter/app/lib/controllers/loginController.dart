...
class loginController extends GetxController {
  ...
  addImages() {
    for (OptionsModel imgGusto in imgGustos) {
      print("ID: ${imgGusto.id}");
      print("questions: ${imgGusto.questions}");

      imgGusto.answer.forEach((url, value) {
        print("Image URL: $url, Selected: $value");
      });
      addIamges(imgGusto.id, imgGusto.questions, imgGusto.answer);
